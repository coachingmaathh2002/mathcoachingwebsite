...
export const tests: Test[] = [
  ...
  },
  {
    ...
    duration: 30,
    questions: [
      { id: 1, text: "Let $\\alpha$ and $\\beta$ be the roots of $x^2 - 6x - 2 = 0$. If $a_n = \\alpha^n - \\beta^n$, for $n \\ge 1$, then the value of $\\frac{a_{10} - 2a_8}{2a_9}$ is:", options: ["3", "6", "-3", "-6"], correctAnswer: 0 },
      { id: 2, text: "Let $\\alpha, \\beta$ be the roots of the equation $x^2 - x - 1 = 0$. If $p_k = (\\alpha)^k + (\\beta)^k$, $k \\ge 1$, then which one of the following statements is not true?", options: ["$p_5 = 11$", "$p_3 = p_5 - p_4$", "$p_4 = 11$", "$p_5 = p_2 \\cdot p_3$"], correctAnswer: 2 },
      { id: 3, text: "The number of real roots of the equation $e^{4x} + e^{3x} - 4e^{2x} + e^x + 1 = 0$ is:", options: ["1", "2", "3", "4"], correctAnswer: 0 },
      { id: 4, text: "If the equations $x^2 + 2x + 3 = 0$ and $ax^2 + bx + c = 0$, $a,b,c \\in \\mathbb{R}$, have a common root, then $a:b:c$ is:", options: ["1:2:3", "3:2:1", "1:3:2", "3:1:2"], correctAnswer: 0 },
      { id: 5, text: "The value of $\\lambda$ such that sum of the squares of the roots of the quadratic equation $x^2 + (3-\\lambda)x + 2 = \\lambda$ has the least value is:", options: ["$15/8$", "1", "2", "3"], correctAnswer: 2 },
      { id: 6, text: "If $\\alpha, \\beta$ are the roots of the equation $x^2 - 2x + 2 = 0$, then the least value of $n$ for which $(\\frac{\\alpha}{\\beta})^n = 1$ is:", options: ["2", "3", "4", "5"], correctAnswer: 2 },
      { id: 7, text: "The sum of the solutions of the equation $|\\sqrt{x} - 2| + \\sqrt{x}(\\sqrt{x} - 4) + 2 = 0$, $(x > 0)$ is equal to:", options: ["4", "9", "10", "12"], correctAnswer: 2 },
      { id: 8, text: "Let $p, q$ be real numbers such that $p+q = 3$ and $p^4 + q^4 = 369$. Then $(\\frac{1}{p} + \\frac{1}{q})^{-2}$ is equal to:", options: ["4", "9", "1/4", "1/9"], correctAnswer: 0 },
      { id: 9, text: "If the roots of the quadratic equation $x^2 + px + q = 0$ are $\\tan 30^\\circ$ and $\\tan 15^\\circ$, respectively, then the value of $2 + q - p$ is:", options: ["2", "3", "0", "1"], correctAnswer: 1 },
      { id: 10, text: "The number of integral values of $m$ for which the quadratic expression $(1+2m)x^2 - 2(1+3m)x + 4(1+m), x \\in \\mathbb{R}$, is always positive, is:", options: ["3", "8", "7", "6"], correctAnswer: 2 }
    ]
  },
  {
    id: 'wbjee_complex_1',
    title: 'Complex Numbers - JEE Main PYQs',
    topic: 'Complex Numbers',
    exam: 'WBJEE',
    duration: 30,
    questions: [
      { id: 1, text: "If $\\alpha, \\beta \\in \\mathbb{C}$ are the distinct roots of the equation $x^2 - x + 1 = 0$, then $\\alpha^{101} + \\beta^{107}$ is equal to:", options: ["0", "1", "2", "-1"], correctAnswer: 1 },
      { id: 2, text: "Let $z$ be a complex number such that $|z| + z = 3 + i$. Then $|z|$ is equal to:", options: ["$5/3$", "$3/4$", "$5/4$", "$4/3$"], correctAnswer: 0 },
      { id: 3, text: "The equation $|z - i| = |z - 1|$ represents:", options: ["a circle", "an ellipse", "a line through the origin", "a line not through the origin"], correctAnswer: 2 },
      { id: 4, text: "If $\\omega \\ne 1$ is a cube root of unity, then the value of $(1 - \\omega + \\omega^2)^5 + (1 + \\omega - \\omega^2)^5$ is:", options: ["32", "-32", "64", "128"], correctAnswer: 0 },
      { id: 5, text: "The value of $\\left(\\frac{1 + i}{1 - i}\\right)^{10}$ is:", options: ["1", "-1", "i", "-i"], correctAnswer: 1 },
      { id: 6, text: "If $z = x + iy$ and $\\arg(\\frac{z-1}{z+1}) = \\frac{\\pi}{4}$, then the locus of $z$ is:", options: ["a circle", "a straight line", "a parabola", "an ellipse"], correctAnswer: 0 },
      { id: 7, text: "The minimum value of $|z-1| + |z-5|$ is:", options: ["4", "5", "6", "1"], correctAnswer: 0 },
      { id: 8, text: "If $|z| = 1$ and $z \\ne \\pm 1$, then all the values of $\\frac{z}{1-z^2}$ lie on:", options: ["the x-axis", "the y-axis", "a circle", "a parabola"], correctAnswer: 1 },
      { id: 9, text: "The roots of the equation $x^3 - 1 = 0$ are:", options: ["$1, \\frac{-1+i\\sqrt{3}}{2}, \\frac{-1-i\\sqrt{3}}{2}$", "$1, \\frac{1+i\\sqrt{3}}{2}, \\frac{1-i\\sqrt{3}}{2}$", "$1, i, -i$", "$1, -1, i$"], correctAnswer: 0 },
      { id: 10, text: "If $z_1, z_2$ are two complex numbers such that $|z_1| = |z_2| = 1$ and $|z_1 + z_2| = \\sqrt{3}$, then $|z_1 - z_2|$ is:", options: ["1", "$\\sqrt{2}$", "$\\sqrt{3}$", "2"], correctAnswer: 0 }
    ]
  },
  {
    id: 'wbjee_matrices_1',
    title: 'Matrices & Determinants - JEE Main PYQs',
    topic: 'Matrices & Determinants',
    exam: 'WBJEE',
    duration: 30,
    questions: [
      { id: 1, text: "If $A = \\begin{pmatrix} 1 & a \\\\ 0 & 1 \\end{pmatrix}$, then $A^n$ (where $n \\in \\mathbb{N}$) is equal to:", options: ["$\\begin{pmatrix} 1 & na \\\\ 0 & 1 \\end{pmatrix}$", "$\\begin{pmatrix} 1 & a^n \\\\ 0 & 1 \\end{pmatrix}$", "$\\begin{pmatrix} n & a \\\\ 0 & n \\end{pmatrix}$", "$\\begin{pmatrix} 1 & n^2a \\\\ 0 & 1 \\end{pmatrix}$"], correctAnswer: 0 },
      { id: 2, text: "If $A$ is a square matrix of order 3 such that $|A| = 5$, then $|adj(A)|$ is equal to:", options: ["25", "125", "5", "15"], correctAnswer: 0 },
      { id: 3, text: "The system of linear equations $x + y + z = 2$, $2x + y - z = 3$, $3x + 2y + kz = 4$ has a unique solution if:", options: ["$k \\ne 0$", "$k \\ne 1$", "$k \\ne -1$", "$k \\ne 2$"], correctAnswer: 0 },
      { id: 4, text: "If $A$ and $B$ are symmetric matrices of the same order, then $AB - BA$ is a:", options: ["Symmetric matrix", "Skew-symmetric matrix", "Diagonal matrix", "Null matrix"], correctAnswer: 1 },
      { id: 5, text: "If $\\omega$ is a complex cube root of unity, then the value of the determinant $\\begin{vmatrix} 1 & \\omega & \\omega^2 \\\\ \\omega & \\omega^2 & 1 \\\\ \\omega^2 & 1 & \\omega \\end{vmatrix}$ is:", options: ["1", "0", "$\\omega$", "$\\omega^2$"], correctAnswer: 1 },
      { id: 6, text: "Let $A$ be a $2 \\times 2$ matrix such that $A^2 - 5A + 7I = 0$. If $A^3 = aA + bI$, then $(a, b)$ is:", options: ["$(18, -35)$", "$(-18, 35)$", "$(18, 35)$", "$(-18, -35)$"], correctAnswer: 0 },
      { id: 7, text: "If $A = \\begin{pmatrix} \\cos\\theta & -\\sin\\theta \\\\ \\sin\\theta & \\cos\\theta \\end{pmatrix}$, then $A^{-1}$ is:", options: ["$\\begin{pmatrix} \\cos\\theta & \\sin\\theta \\\\ -\\sin\\theta & \\cos\\theta \\end{pmatrix}$", "$\\begin{pmatrix} \\cos\\theta & -\\sin\\theta \\\\ \\sin\\theta & \\cos\\theta \\end{pmatrix}$", "$\\begin{pmatrix} -\\cos\\theta & \\sin\\theta \\\\ -\\sin\\theta & -\\cos\\theta \\end{pmatrix}$", "$\\begin{pmatrix} \\sin\\theta & \\cos\\theta \\\\ -\\cos\\theta & \\sin\\theta \\end{pmatrix}$"], correctAnswer: 0 },
      { id: 8, text: "If $A$ is a singular matrix, then $|A|$ is:", options: ["1", "0", "-1", "Not defined"], correctAnswer: 1 },
      { id: 9, text: "The maximum value of $\\Delta = \\begin{vmatrix} 1 & 1 & 1 \\\\ 1 & 1+\\sin\\theta & 1 \\\\ 1+\\cos\\theta & 1 & 1 \\end{vmatrix}$ is ($\\theta$ is real):", options: ["1/2", "$\\sqrt{3}/2$", "1", "2"], correctAnswer: 0 },
      { id: 10, text: "If $A$ is a $3 \\times 3$ matrix and $|A| = 4$, then $|3A|$ is:", options: ["12", "36", "108", "4"], correctAnswer: 2 }
    ]
  },

  {
    id: 'wbjee_indefinite_integral_2',
    title: 'Indefinite Integral - Advanced Level',
    topic: 'Indefinite Integral',
    exam: 'WBJEE',
    duration: 60,
    questions: [
      { id: 1, text: "$\\int \\frac{x^2-1}{x^4+3x^2+1} dx = ?$", options: ["$\\frac{1}{2}\\ln|\\frac{x^2-x+1}{x^2+x+1}| + C$", "$\\tan^{-1}(x+\\frac{1}{x}) + C$", "$\\frac{1}{2}\\ln|\\frac{x^2+x+1}{x^2-x+1}| + C$", "$\\ln|\\frac{x^2-1}{x^2+1}| + C$"], correctAnswer: 0 },
      { id: 2, text: "$\\int \\frac{dx}{x^2(x^4+1)^{3/4}} = ?$", options: ["$-(\\frac{x^4+1}{x^4})^{1/4} + C$", "$(\\frac{x^4+1}{x^4})^{1/4} + C$", "$-(\\frac{x^4+1}{x^4})^{3/4} + C$", "$\\frac{1}{4}(\\frac{x^4+1}{x^4})^{1/4} + C$"], correctAnswer: 0 },
      { id: 3, text: "$\\int \\frac{x^2}{(x\\sin x + \\cos x)^2} dx = ?$", options: ["$\\frac{\\sin x + x\\cos x}{x\\sin x + \\cos x} + C$", "$\\frac{\\sin x - x\\cos x}{x\\sin x + \\cos x} + C$", "$-\\frac{\\sin x + x\\cos x}{x\\sin x + \\cos x} + C$", "$\\frac{x\\sin x - \\cos x}{x\\sin x + \\cos x} + C$"], correctAnswer: 1 },
      { id: 4, text: "$\\int \\frac{\\sqrt{x^2+1}[\\ln(x^2+1) - 2\\ln x]}{x^4} dx = ?$", options: ["$\\frac{1}{3}(1+\\frac{1}{x^2})^{3/2}[\\ln(1+\\frac{1}{x^2})-\\frac{2}{3}] + C$", "$-\\frac{1}{3}(1+\\frac{1}{x^2})^{3/2}[\\ln(1+\\frac{1}{x^2})-\\frac{2}{3}] + C$", "$\\frac{2}{3}(1+\\frac{1}{x^2})^{3/2}[\\ln(1+\\frac{1}{x^2})-\\frac{2}{3}] + C$", "$-\\frac{2}{3}(1+\\frac{1}{x^2})^{3/2}[\\ln(1+\\frac{1}{x^2})+\\frac{2}{3}] + C$"], correctAnswer: 1 },
      { id: 5, text: "$\\int e^{\\tan^{-1} x} (\\frac{1+x+x^2}{1+x^2}) dx = ?$", options: ["$x e^{\\tan^{-1} x} + C$", "$e^{\\tan^{-1} x} + C$", "$(1+x) e^{\\tan^{-1} x} + C$", "$\\frac{e^{\\tan^{-1} x}}{1+x^2} + C$"], correctAnswer: 0 },
      { id: 6, text: "$\\int \\frac{\\sin 2x}{\\sin^4 x + \\cos^4 x} dx = ?$", options: ["$\\tan^{-1}(\\tan^2 x) + C$", "$\\tan^{-1}(\\cos^2 x) + C$", "$\\ln(\\sin^4 x + \\cos^4 x) + C$", "$\\frac{1}{2}\\tan^{-1}(\\sin^2 x) + C$"], correctAnswer: 0 },
      { id: 7, text: "$\\int \\frac{dx}{\\cos^3 x \\sqrt{2\\sin 2x}} = ?$", options: ["$\\sqrt{\\tan x}(1+\\frac{1}{5}\\tan^2 x) + C$", "$\\frac{1}{\\sqrt{2}}\\sqrt{\\tan x}(1+\\frac{1}{5}\\tan^2 x) + C$", "$\\sqrt{2\\tan x}(1+\\frac{1}{5}\\tan^2 x) + C$", "$\\frac{1}{2}\\sqrt{\\tan x}(1+\\tan^2 x) + C$"], correctAnswer: 2 },
      { id: 8, text: "$\\int e^x (\\frac{1-\\sin x}{1-\\cos x}) dx = ?$", options: ["$-e^x \\cot(x/2) + C$", "$e^x \\tan(x/2) + C$", "$e^x \\cot(x/2) + C$", "$-e^x \\tan(x/2) + C$"], correctAnswer: 0 },
      { id: 9, text: "$\\int \\frac{x^4 - 1}{x^2 \\sqrt{x^4+x^2+1}} dx = ?$", options: ["$\\sqrt{\\frac{x^4+x^2+1}{x^2}} + C$", "$\\frac{\\sqrt{x^4+x^2+1}}{x} + C$", "$\\sqrt{x^2 + 1 + \\frac{1}{x^2}} + C$", "$\\text{All of the above}$"], correctAnswer: 3 },
      { id: 10, text: "$\\int \\frac{dx}{x^3(x^2+1)^3} = ?$", options: ["$\\frac{1}{2x^2} - \\frac{3}{2(x^2+1)} - \\frac{1}{(x^2+1)^2} - \\frac{1}{2(x^2+1)^3} + C$", "$-\\frac{1}{2x^2} - \\frac{3}{2}\\ln(1+\\frac{1}{x^2}) + \\frac{1}{(x^2+1)^2} + C$", "$\\ln|x| - \\frac{1}{4(x^2+1)^2} - \\frac{3}{2}\\ln(x^2+1) + C$", "$-\\frac{1}{2x^2} - \\ln\\sqrt{1+\\frac{1}{x^2}} + \\frac{1}{2(x^2+1)} + \\frac{1}{4(x^2+1)^2} + C$"], correctAnswer: 3 },
      { id: 11, text: "$\\int (\\sqrt{\\tan x} + \\sqrt{\\cot x}) dx = ?$", options: ["$\\sqrt{2}\\tan^{-1}(\\frac{\\tan x - 1}{\\sqrt{2\\tan x}}) + C$", "$\\sqrt{2}\\sin^{-1}(\\sin x - \\cos x) + C$", "$\\sqrt{2}\\cos^{-1}(\\sin x + \\cos x) + C$", "$\\frac{1}{\\sqrt{2}}\\sin^{-1}(\\sin x - \\cos x) + C$"], correctAnswer: 1 },
      { id: 12, text: "$\\int \\frac{1+x\\cos x}{x(1-x^2 e^{2\\sin x})} dx = ?$", options: ["$\\ln|\\frac{x}{1-x e^{\\sin x}}| + C$", "$\\frac{1}{2}\\ln|\\frac{1+x e^{\\sin x}}{1-x e^{\\sin x}}| + C$", "$\\frac{1}{2}\\ln|\\frac{x e^{\\sin x}}{1-x^2 e^{2\\sin x}}| + C$", "$\\ln|\\frac{x e^{\\sin x}}{\\sqrt{1-x^2 e^{2\\sin x}}}| + C$"], correctAnswer: 1 },
      { id: 13, text: "$\\int \\frac{\\cos x - \\sin x}{\\sqrt{8 - \\sin 2x}} dx = ?$", options: ["$\\sin^{-1}(\\frac{\\sin x + \\cos x}{3}) + C$", "$\\sin^{-1}(\\frac{\\sin x - \\cos x}{3}) + C$", "$\\frac{1}{3}\\sin^{-1}(\\sin x + \\cos x) + C$", "$\\ln|\\sin x + \\cos x + \\sqrt{8-\\sin 2x}| + C$"], correctAnswer: 0 },
      { id: 14, text: "$\\int \\frac{x^3 + 3x + 2}{(x^2+1)^2(x+1)} dx = ?$", options: ["$\\frac{1}{4}\\ln|\\frac{x+1}{x^2+1}| - \\frac{1}{2(x^2+1)} + \\frac{3}{2}\\tan^{-1}x + C$", "$\\frac{1}{2}\\ln|x+1| - \\frac{1}{4}\\ln(x^2+1) + \\frac{x}{2(x^2+1)} + \\tan^{-1}x + C$", "$\\frac{1}{2}\\ln|\\frac{x+1}{\\sqrt{x^2+1}}| - \\frac{1}{x^2+1} + \\frac{1}{2}\\tan^{-1}x + C$", "$\\ln|x+1| - \\frac{1}{x^2+1} + \\tan^{-1}x + C$"], correctAnswer: 1 },
      { id: 15, text: "$\\int \\frac{\\ln(x + \\sqrt{x^2+1})}{\\sqrt{x^2+1}} dx = ?$", options: ["$\\frac{1}{2}[\\ln(x + \\sqrt{x^2+1})]^2 + C$", "$[\\ln(x + \\sqrt{x^2+1})]^2 + C$", "$\\sqrt{x^2+1}\\ln(x + \\sqrt{x^2+1}) - x + C$", "$\\frac{x}{\\sqrt{x^2+1}}\\ln(x + \\sqrt{x^2+1}) + C$"], correctAnswer: 0 },
      { id: 16, text: "$\\int \\frac{x^2 - 1}{x^3 \\sqrt{2x^4 - 2x^2 + 1}} dx = ?$", options: ["$\\frac{\\sqrt{2x^4 - 2x^2 + 1}}{x^2} + C$", "$\\frac{\\sqrt{2x^4 - 2x^2 + 1}}{2x^2} + C$", "$\\frac{\\sqrt{2x^4 - 2x^2 + 1}}{x^3} + C$", "$\\frac{1}{2}\\sqrt{2 - \\frac{2}{x^2} + \\frac{1}{x^4}} + C$"], correctAnswer: 3 },
      { id: 17, text: "$\\int \\frac{dx}{x^4 + 1} = ?$", options: ["$\\frac{1}{2\\sqrt{2}}\\tan^{-1}(\\frac{x^2-1}{\\sqrt{2}x}) - \\frac{1}{4\\sqrt{2}}\\ln|\\frac{x^2-\\sqrt{2}x+1}{x^2+\\sqrt{2}x+1}| + C$", "$\\frac{1}{2\\sqrt{2}}\\tan^{-1}(\\frac{x^2-1}{\\sqrt{2}x}) + \\frac{1}{4\\sqrt{2}}\\ln|\\frac{x^2-\\sqrt{2}x+1}{x^2+\\sqrt{2}x+1}| + C$", "$\\frac{1}{\\sqrt{2}}\\tan^{-1}(\\frac{x^2-1}{\\sqrt{2}x}) + C$", "$\\frac{1}{4\\sqrt{2}}\\ln|\\frac{x^2-\\sqrt{2}x+1}{x^2+\\sqrt{2}x+1}| + C$"], correctAnswer: 0 },
      { id: 18, text: "$\\int (\\frac{x}{x\\sin x + \\cos x})^2 dx = ?$", options: ["$\\frac{\\sin x - x\\cos x}{x\\sin x + \\cos x} + C$", "$\\frac{\\tan x - x}{x\\tan x + 1} + C$", "$\\tan x - \\frac{x\\sin x}{x\\sin x + \\cos x} + C$", "$\\frac{\\sin x}{x\\sin x + \\cos x} - \\cos x + C$"], correctAnswer: 2 },
      { id: 19, text: "$\\int e^x \\frac{x^3 - x + 2}{(x^2+1)^2} dx = ?$", options: ["$e^x \\frac{x}{x^2+1} + C$", "$e^x \\frac{1}{x^2+1} + C$", "$e^x \\frac{x-1}{x^2+1} + C$", "$e^x \\frac{x+1}{x^2+1} + C$"], correctAnswer: 2 },
      { id: 20, text: "$\\int \\frac{\\sin x \\cos x}{\\sqrt{a^2\\sin^2 x + b^2\\cos^2 x}} dx = ?$", options: ["$\\frac{1}{a^2-b^2}\\sqrt{a^2\\sin^2 x + b^2\\cos^2 x} + C$", "$\\frac{2}{a^2-b^2}\\sqrt{a^2\\sin^2 x + b^2\\cos^2 x} + C$", "$\\frac{1}{2(a^2-b^2)}\\sqrt{a^2\\sin^2 x + b^2\\cos^2 x} + C$", "$\\frac{1}{\\sqrt{a^2-b^2}}\\ln|a^2\\sin^2 x + b^2\\cos^2 x| + C$"], correctAnswer: 0 },
      { id: 21, text: "$\\int \\frac{1}{\\sin^4 x + \\cos^4 x} dx = ?$", options: ["$\\frac{1}{\\sqrt{2}}\\tan^{-1}(\\frac{\\tan x - \\cot x}{\\sqrt{2}}) + C$", "$\\frac{1}{\\sqrt{2}}\\tan^{-1}(\\frac{\\tan^2 x - 1}{\\sqrt{2}\\tan x}) + C$", "$\\frac{1}{\\sqrt{2}}\\tan^{-1}(\\frac{\\sin 2x}{\\sqrt{2}\\cos 2x}) + C$", "$\\text{Both A and B are correct forms}$"], correctAnswer: 3 },
      { id: 22, text: "$\\int x^2 e^{x^3} (3x^3 + 2) dx = ?$", options: ["$x^2 e^{x^3} + C$", "$x^3 e^{x^3} + C$", "$x e^{x^3} + C$", "$\\frac{1}{3}x^3 e^{x^3} + C$"], correctAnswer: 1 },
      { id: 23, text: "$\\int \\frac{x^2 - 1}{(x^4+3x^2+1)\\tan^{-1}(\\frac{x^2+1}{x})} dx = ?$", options: ["$\\ln|\\tan^{-1}(\\frac{x^2+1}{x})| + C$", "$\\ln|x^4+3x^2+1| + C$", "$\\tan^{-1}(\\frac{x^2+1}{x}) + C$", "$\\frac{1}{2}\\ln|\\tan^{-1}(\\frac{x^2+1}{x})| + C$"], correctAnswer: 0 },
      { id: 24, text: "$\\int \\sqrt{\\frac{1-\\sqrt{x}}{1+\\sqrt{x}}} dx = ?$", options: ["$\\cos^{-1}\\sqrt{x} + \\sqrt{1-x} + C$", "$\\cos^{-1}\\sqrt{x} - \\sqrt{x-x^2} + C$", "$2\\sin^{-1}\\sqrt{x} - \\sqrt{x-x^2} + C$", "$\\cos^{-1}\\sqrt{x} - \\sqrt{x}\\sqrt{1-x} + C$"], correctAnswer: 3 },
      { id: 25, text: "$\\int \\frac{dx}{\\cos^6 x + \\sin^6 x} = ?$", options: ["$\\tan^{-1}(\\tan x - \\cot x) + C$", "$\\tan x - \\cot x + C$", "$\\tan^{-1}(\\tan x) + \\cot^{-1}(\\cot x) + C$", "$\\tan^{-1}(2\\cot 2x) + C$"], correctAnswer: 0 },
      { id: 26, text: "$\\int \\frac{x^3}{1+x^8} dx = ?$", options: ["$\\frac{1}{4}\\tan^{-1}(x^4) + C$", "$\\frac{1}{8}\\ln(1+x^8) + C$", "$\\frac{1}{4}\\sin^{-1}(x^4) + C$", "$\\tan^{-1}(x^4) + C$"], correctAnswer: 0 },
      { id: 27, text: "$\\int \\frac{dx}{(x-1)^{3/4}(x+2)^{5/4}} = ?$", options: ["$\\frac{4}{3}(\\frac{x-1}{x+2})^{1/4} + C$", "$\\frac{3}{4}(\\frac{x-1}{x+2})^{1/4} + C$", "$\\frac{4}{3}(\\frac{x+2}{x-1})^{1/4} + C$", "$\\frac{4}{3}(\\frac{x-1}{x+2})^{5/4} + C$"], correctAnswer: 0 },
      { id: 28, text: "$\\int \\frac{\\sin x}{\\sin x + \\cos x} dx = ?$", options: ["$\\frac{x}{2} - \\frac{1}{2}\\ln|\\sin x + \\cos x| + C$", "$\\frac{x}{2} + \\frac{1}{2}\\ln|\\sin x + \\cos x| + C$", "$\\ln|\\sin x + \\cos x| - \\frac{x}{2} + C$", "$\\frac{1}{2}\\ln|\\sin x - \\cos x| + C$"], correctAnswer: 0 },
      { id: 29, text: "$\\int \\frac{dx}{1 - x^4} = ?$", options: ["$\\frac{1}{4}\\ln|\\frac{1+x}{1-x}| + \\frac{1}{2}\\tan^{-1}x + C$", "$\\frac{1}{2}\\ln|\\frac{1+x}{1-x}| + \\frac{1}{4}\\tan^{-1}x + C$", "$\\frac{1}{4}\\ln|\\frac{1-x}{1+x}| + \\frac{1}{2}\\tan^{-1}x + C$", "$\\frac{1}{2}\\ln|\\frac{1+x}{1-x}| - \\frac{1}{2}\\tan^{-1}x + C$"], correctAnswer: 0 },
      { id: 30, text: "$\\int e^x (\\frac{2+\\sin 2x}{1+\\cos 2x}) dx = ?$", options: ["$e^x \\tan x + C$", "$e^x \\cot x + C$", "$2e^x \\tan x + C$", "$e^x \\sec^2 x + C$"], correctAnswer: 0 },
      { id: 31, text: "$\\int \\frac{\\cos 2x}{(\\sin x + \\cos x)^2} dx = ?$", options: ["$\\ln|\\sin x + \\cos x| + C$", "$\\ln|\\sin x - \\cos x| + C$", "$\\frac{1}{\\sin x + \\cos x} + C$", "$-\\frac{1}{\\sin x + \\cos x} + C$"], correctAnswer: 0 },
      { id: 32, text: "$\\int \\sqrt{\\frac{x-1}{x+1}} \\frac{1}{x^2} dx = ?$", options: ["$\\sin^{-1}(\\frac{1}{x}) + \\frac{\\sqrt{x^2-1}}{x} + C$", "$\\sec^{-1}x + \\frac{\\sqrt{x^2-1}}{x} + C$", "$\\cos^{-1}(\\frac{1}{x}) + \\frac{\\sqrt{x^2-1}}{x} + C$", "$\\sec^{-1}x - \\frac{\\sqrt{x^2-1}}{x} + C$"], correctAnswer: 1 },
      { id: 33, text: "$\\int \\frac{dx}{x\\sqrt{x^6 - 1}} = ?$", options: ["$\\frac{1}{3}\\sec^{-1}(x^3) + C$", "$\\frac{1}{3}\\tan^{-1}(x^3) + C$", "$\\sec^{-1}(x^3) + C$", "$\\frac{1}{6}\\ln|\\frac{x^3-1}{x^3+1}| + C$"], correctAnswer: 0 },
      { id: 34, text: "$\\int \\frac{x^2 + \\cos^2 x}{x^2+1} \\text{cosec}^2 x dx = ?$", options: ["$-\\cot x - \\tan^{-1}x + C$", "$\\cot x - \\tan^{-1}x + C$", "$-\\cot x + \\tan^{-1}x + C$", "$\\tan x - \\cot^{-1}x + C$"], correctAnswer: 0 },
      { id: 35, text: "$\\int \\frac{dx}{\\sin(x-a)\\sin(x-b)} = ?$", options: ["$\\frac{1}{\\sin(a-b)}\\ln|\\frac{\\sin(x-a)}{\\sin(x-b)}| + C$", "$\\frac{1}{\\cos(a-b)}\\ln|\\frac{\\cos(x-a)}{\\cos(x-b)}| + C$", "$\\frac{1}{\\sin(a-b)}\\ln|\\frac{\\sin(x-b)}{\\sin(x-a)}| + C$", "$\\frac{1}{\\cos(a-b)}\\ln|\\frac{\\sin(x-a)}{\\sin(x-b)}| + C$"], correctAnswer: 0 },
      { id: 36, text: "$\\int \\frac{1+x^4}{(1-x^4)^{3/2}} dx = ?$", options: ["$\\frac{x}{\\sqrt{1-x^4}} + C$", "$\\frac{x^2}{\\sqrt{1-x^4}} + C$", "$\\frac{x}{(1-x^4)^{3/2}} + C$", "$\\frac{1}{\\sqrt{1-x^4}} + C$"], correctAnswer: 0 },
      { id: 37, text: "$\\int \\frac{\\ln(\\tan x)}{\\sin x \\cos x} dx = ?$", options: ["$\\frac{1}{2}(\\ln(\\tan x))^2 + C$", "$(\\ln(\\tan x))^2 + C$", "$\\ln(\\tan x) + C$", "$\\frac{1}{2}\\ln(\\tan^2 x) + C$"], correctAnswer: 0 },
      { id: 38, text: "$\\int x \\sqrt{\\frac{1-x^2}{1+x^2}} dx = ?$", options: ["$\\frac{1}{2}\\sin^{-1}(x^2) - \\frac{1}{2}\\sqrt{1-x^4} + C$", "$\\frac{1}{2}\\cos^{-1}(x^2) + \\frac{1}{2}\\sqrt{1-x^4} + C$", "$\\sin^{-1}(x^2) - \\sqrt{1-x^4} + C$", "$\\frac{1}{2}\\sin^{-1}(x^2) + \\frac{1}{2}\\sqrt{1-x^4} + C$"], correctAnswer: 0 },
      { id: 39, text: "$\\int \\frac{dx}{x^2 - x + 1} = ?$", options: ["$\\frac{2}{\\sqrt{3}}\\tan^{-1}(\\frac{2x-1}{\\sqrt{3}}) + C$", "$\\frac{1}{\\sqrt{3}}\\tan^{-1}(\\frac{2x-1}{\\sqrt{3}}) + C$", "$\\frac{2}{\\sqrt{3}}\\ln|\\frac{2x-1-\\sqrt{3}}{2x-1+\\sqrt{3}}| + C$", "$\\frac{1}{\\sqrt{3}}\\ln|\\frac{2x-1-\\sqrt{3}}{2x-1+\\sqrt{3}}| + C$"], correctAnswer: 0 },
      { id: 40, text: "$\\int \\frac{x e^x}{\\sqrt{1+e^x}} dx = ?$", options: ["$2x\\sqrt{1+e^x} - 4\\sqrt{1+e^x} + 2\\ln|\\frac{\\sqrt{1+e^x}-1}{\\sqrt{1+e^x}+1}| + C$", "$2x\\sqrt{1+e^x} - 4\\sqrt{1+e^x} + C$", "$2x\\sqrt{1+e^x} - 4\\sqrt{1+e^x} + 2\\ln|\\frac{\\sqrt{1+e^x}+1}{\\sqrt{1+e^x}-1}| + C$", "$x\\sqrt{1+e^x} - 2\\sqrt{1+e^x} + \\ln|\\frac{\\sqrt{1+e^x}-1}{\\sqrt{1+e^x}+1}| + C$"], correctAnswer: 0 },
      { id: 41, text: "$\\int \\frac{\\tan x}{1+\\tan x + \\tan^2 x} dx = ?$", options: ["$x - \\frac{2}{\\sqrt{3}}\\tan^{-1}(\\frac{2\\tan x + 1}{\\sqrt{3}}) + C$", "$x + \\frac{2}{\\sqrt{3}}\\tan^{-1}(\\frac{2\\tan x + 1}{\\sqrt{3}}) + C$", "$\\frac{1}{\\sqrt{3}}\\tan^{-1}(\\frac{2\\tan x + 1}{\\sqrt{3}}) - x + C$", "$\\text{None of the above}$"], correctAnswer: 0 },
      { id: 42, text: "$\\int \\frac{1 - x^2}{x(1+x^2+x^4)} dx = ?$", options: ["$\\frac{1}{2}\\ln|\\frac{x^2-x+1}{x^2+x+1}| + C$", "$\\frac{1}{2}\\ln|\\frac{x^2}{x^4+x^2+1}| + C$", "$\\ln|\\frac{x^2-1}{x^2+1}| + C$", "$\\frac{1}{2}\\ln|\\frac{x^4+x^2+1}{x^2}| + C$"], correctAnswer: 1 },
      { id: 43, text: "$\\int (\\frac{\\ln x - 1}{(\\ln x)^2})^2 dx = ?$", options: ["$\\frac{x}{(\\ln x)^2} - \\frac{x}{(\\ln x)^3} + C$", "$\\frac{x}{(\\ln x)^2} - \\frac{2x}{(\\ln x)^3} + C$", "$\\frac{x}{(\\ln x)^2} - \\frac{x}{(\\ln x)^4} + C$", "$\\frac{x}{(\\ln x)^2} - \\frac{2x}{(\\ln x)^3} + \\frac{x}{(\\ln x)^4} + C$"], correctAnswer: 0 },
      { id: 44, text: "$\\int \\frac{dx}{x^2 \\sqrt{1+x^2}} = ?$", options: ["$-\\frac{\\sqrt{1+x^2}}{x} + C$", "$\\frac{\\sqrt{1+x^2}}{x} + C$", "$-\\frac{\\sqrt{1+x^2}}{x^2} + C$", "$\\ln|x + \\sqrt{1+x^2}| - \\frac{\\sqrt{1+x^2}}{x} + C$"], correctAnswer: 0 },
      { id: 45, text: "$\\int \\frac{\\sec^2 x}{(\\sec x + \\tan x)^{9/2}} dx = ?$", options: ["$-\\frac{1}{(\\sec x + \\tan x)^{7/2}} (\\frac{1}{7} + \\frac{(\\sec x + \\tan x)^2}{11}) + C$", "$-\\frac{1}{(\\sec x + \\tan x)^{11/2}} (\\frac{1}{11} + \\frac{(\\sec x + \\tan x)^2}{7}) + C$", "$-\\frac{1}{2(\\sec x + \\tan x)^{7/2}} (\\frac{1}{7} + \\frac{(\\sec x + \\tan x)^2}{11}) + C$", "$\\frac{1}{2(\\sec x + \\tan x)^{11/2}} (\\frac{1}{11} + \\frac{(\\sec x + \\tan x)^2}{7}) + C$"], correctAnswer: 1 },
      { id: 46, text: "$\\int \\frac{x+1}{x(1+x e^x)^2} dx = ?$", options: ["$\\ln|\\frac{x e^x}{1+x e^x}| + \\frac{1}{1+x e^x} + C$", "$\\ln|\\frac{1+x e^x}{x e^x}| + \\frac{1}{1+x e^x} + C$", "$\\ln|\\frac{x e^x}{1+x e^x}| - \\frac{1}{1+x e^x} + C$", "$\\ln|\\frac{1+x e^x}{x e^x}| - \\frac{1}{1+x e^x} + C$"], correctAnswer: 0 },
      { id: 47, text: "$\\int \\frac{x^2}{(x^2+1)(x^2+4)} dx = ?$", options: ["$\\frac{1}{3}\\tan^{-1}x - \\frac{2}{3}\\tan^{-1}(x/2) + C$", "$\\frac{2}{3}\\tan^{-1}(x/2) - \\frac{1}{3}\\tan^{-1}x + C$", "$\\frac{1}{3}\\tan^{-1}x + \\frac{2}{3}\\tan^{-1}(x/2) + C$", "$\\tan^{-1}x - 2\\tan^{-1}(x/2) + C$"], correctAnswer: 1 },
      { id: 48, text: "$\\int \\frac{\\sin x}{\\sin 4x} dx = ?$", options: ["$-\\frac{1}{4}\\ln|\\frac{\\cos x - \\frac{1}{\\sqrt{2}}}{\\cos x + \\frac{1}{\\sqrt{2}}}| + C$", "$\\frac{1}{4\\sqrt{2}}\\ln|\\frac{1-\\sqrt{2}\\cos x}{1+\\sqrt{2}\\cos x}| + C$", "$\\frac{1}{8\\sqrt{2}}\\ln|\\frac{\\sqrt{2}\\cos x - 1}{\\sqrt{2}\\cos x + 1}| + C$", "$\\frac{1}{4\\sqrt{2}}\\ln|\\frac{\\sqrt{2}\\cos x + 1}{\\sqrt{2}\\cos x - 1}| + C$"], correctAnswer: 3 },
      { id: 49, text: "$\\int e^x \\frac{1+n x^{n-1}-x^n}{(1-x^n)^2} dx = ?$", options: ["$\\frac{e^x}{1-x^n} + C$", "$\\frac{e^x x^n}{1-x^n} + C$", "$\\frac{e^x(1-x^n)}{1+x^n} + C$", "$\\frac{e^x}{1+x^n} + C$"], correctAnswer: 0 },
      { id: 50, text: "$\\int \\sqrt{\\frac{x}{a^3 - x^3}} dx = ?$", options: ["$\\frac{2}{3}\\sin^{-1}((\\frac{x}{a})^{3/2}) + C$", "$\\frac{2}{3}\\cos^{-1}((\\frac{x}{a})^{3/2}) + C$", "$\\frac{2}{3a}\\sin^{-1}((\\frac{x}{a})^{3/2}) + C$", "$\\frac{3}{2}\\sin^{-1}((\\frac{x}{a})^{3/2}) + C$"], correctAnswer: 0 }
    ]
  },
  {
    id: 'wbjee_limit_continuity_adv_1',
    title: 'Limit and Continuity - Advanced Level',
    topic: 'Limit and Continuity',
    exam: 'WBJEE',
    duration: 60,
    questions: [
      { id: 1, text: "If $f(x) = \\frac{\\sin(e^{x-2}-1)}{\\ln(x-1)}$ for $x \\neq 2$ and $f(2) = k$ is continuous at $x=2$, then $k = ?$", options: ["0", "1", "2", "$e$"], correctAnswer: 1 },
      { id: 2, text: "$\\lim_{x \\to 0} \\frac{1}{x} \\int_0^x (1+\\sin 2t)^{1/t} dt = ?$", options: ["$e$", "$e^2$", "$1$", "$0$"], correctAnswer: 1 },
      { id: 3, text: "$\\lim_{n \\to \\infty} \\prod_{k=1}^n \\cos(\\frac{x}{2^k}) = ?$", options: ["$\\frac{\\sin x}{x}$", "$\\frac{x}{\\sin x}$", "$\\sin x$", "$\\cos x$"], correctAnswer: 0 },
      { id: 4, text: "If $f(x) = [x] \\cos(\\frac{2x-1}{2}\\pi)$, where $[.]$ is GIF. Then $f(x)$ is discontinuous at:", options: ["All integers", "All non-integers", "Nowhere", "Everywhere"], correctAnswer: 2 },
      { id: 5, text: "$\\lim_{x \\to 0} \\frac{\\sin(\\pi \\cos^2 x)}{x^2} = ?$", options: ["$\\pi$", "$-\\pi$", "$1$", "$0$"], correctAnswer: 0 },
      { id: 6, text: "$\\lim_{x \\to \\infty} (\\frac{x^2+1}{x^2-1})^{x^2} = ?$", options: ["$e$", "$e^2$", "$e^{-1}$", "$1$"], correctAnswer: 1 },
      { id: 7, text: "$\\lim_{x \\to 0} (\\frac{1+\\tan x}{1+\\sin x})^{\\csc^3 x} = ?$", options: ["$e$", "$e^{1/2}$", "$e^{-1/2}$", "$1$"], correctAnswer: 1 },
      { id: 8, text: "$\\lim_{n \\to \\infty} n \\sin(2\\pi e n!) = ?$", options: ["$0$", "$\\pi$", "$2\\pi$", "$\\infty$"], correctAnswer: 2 },
      { id: 9, text: "$\\lim_{x \\to 0} \\frac{\\int_0^{x^2} \\sec^2 t dt}{x \\sin x} = ?$", options: ["$0$", "$1$", "$2$", "$\\infty$"], correctAnswer: 1 },
      { id: 10, text: "$\\lim_{x \\to 0} \\frac{e^x - e^{-x} - 2x}{x-\\sin x} = ?$", options: ["$1$", "$2$", "$1/2$", "$0$"], correctAnswer: 1 },
      { id: 11, text: "$\\lim_{x \\to 1} (1-x) \\tan(\\frac{\\pi x}{2}) = ?$", options: ["$\\pi/2$", "$2/\\pi$", "$\\pi$", "$0$"], correctAnswer: 1 },
      { id: 12, text: "$\\lim_{x \\to \\infty} x (\\tan^{-1}(\\frac{x+1}{x+2}) - \\frac{\\pi}{4}) = ?$", options: ["$1/2$", "$-1/2$", "$1$", "$-1$"], correctAnswer: 1 },
      { id: 13, text: "Let $f(x) = \\frac{1-\\cos 4x}{x^2}$ for $x < 0$, $a$ for $x=0$, $\\frac{\\sqrt{x}}{\\sqrt{16+\\sqrt{x}}-4}$ for $x > 0$. Find $a$ for continuity.", options: ["$4$", "$8$", "$16$", "$2$"], correctAnswer: 1 },
      { id: 14, text: "$\\lim_{x \\to 0} \\frac{x \\cot(4x)}{\\sin^2 x \\cot^2(2x)} = ?$", options: ["$1$", "$1/2$", "$1/4$", "$2$"], correctAnswer: 0 },
      { id: 15, text: "$\\lim_{x \\to 0} \\frac{1 - \\cos(1-\\cos x)}{x^4} = ?$", options: ["$1/2$", "$1/4$", "$1/8$", "$1/16$"], correctAnswer: 2 },
      { id: 16, text: "$\\lim_{x \\to \\pi/2} (\\sin x)^{\\tan x} = ?$", options: ["$e$", "$1$", "$0$", "$\\infty$"], correctAnswer: 1 },
      { id: 17, text: "$\\lim_{x \\to 0} \\frac{\\ln(1+x+x^2) + \\ln(1-x+x^2)}{x^2} = ?$", options: ["$0$", "$1$", "$2$", "$-1$"], correctAnswer: 1 },
      { id: 18, text: "$\\lim_{x \\to 0} \\frac{\\sqrt{1+x\\sin x} - \\sqrt{\\cos 2x}}{\\tan^2(x/2)} = ?$", options: ["$2$", "$4$", "$6$", "$8$"], correctAnswer: 2 },
      { id: 19, text: "$\\lim_{x \\to \\infty} (\\frac{a^{1/x} + b^{1/x} + c^{1/x}}{3})^x = ?$", options: ["$abc$", "$(abc)^{1/3}$", "$a+b+c$", "$0$"], correctAnswer: 1 },
      { id: 20, text: "$\\lim_{x \\to 0} \\frac{\\sin^{-1} x - \\tan^{-1} x}{x^3} = ?$", options: ["$1/2$", "$1/3$", "$1/6$", "$1$"], correctAnswer: 0 },
      { id: 21, text: "$\\lim_{x \\to 0} \\frac{e^x + e^{-x} - 2}{x^2} = ?$", options: ["$1/2$", "$1$", "$2$", "$0$"], correctAnswer: 1 },
      { id: 22, text: "Let $f(x) = [x^2] \\sin(\\pi x)$. Where is it discontinuous?", options: ["All integers", "All non-integers", "At $x = \\sqrt{n}$ where $n$ is an integer, except perfect squares", "Nowhere"], correctAnswer: 2 },
      { id: 23, text: "$\\lim_{x \\to 0} \\frac{1}{x^3} \\int_0^x \\frac{t^2 dt}{t^4+1} = ?$", options: ["$1/3$", "$1/4$", "$1$", "$0$"], correctAnswer: 0 },
      { id: 24, text: "$\\lim_{x \\to 0} \\frac{x - \\sin x}{x - \\tan x} = ?$", options: ["$1/2$", "$-1/2$", "$1/3$", "$-1/3$"], correctAnswer: 1 },
      { id: 25, text: "$\\lim_{n \\to \\infty} \\cos(\\frac{x}{2}) \\cos(\\frac{x}{4}) ... \\cos(\\frac{x}{2^n}) = ?$", options: ["$\\frac{\\sin x}{x}$", "$\\frac{x}{\\sin x}$", "$\\cos x$", "$1$"], correctAnswer: 0 },
      { id: 26, text: "$\\lim_{x \\to 0} \\frac{\\cos x - \\sec x}{x^2(x+1)} = ?$", options: ["$1$", "$-1$", "$1/2$", "$-1/2$"], correctAnswer: 1 },
      { id: 27, text: "$\\lim_{x \\to 0} \\frac{2^x - 1}{\\sqrt{1+x} - 1} = ?$", options: ["$\\ln 2$", "$2 \\ln 2$", "$\\frac{1}{2} \\ln 2$", "$1$"], correctAnswer: 1 },
      { id: 28, text: "$\\lim_{x \\to \\infty} x (\\ln(x+a) - \\ln x) = ?$", options: ["$a$", "$1/a$", "$e^a$", "$0$"], correctAnswer: 0 },
      { id: 29, text: "$\\lim_{x \\to 0} \\frac{e^{x^2} - \\cos x}{x^2} = ?$", options: ["$1/2$", "$1$", "$3/2$", "$2$"], correctAnswer: 2 },
      { id: 30, text: "$\\lim_{x \\to 0} \\frac{\\sqrt{1-\\cos 2x}}{\\sqrt{2} x} = ?$", options: ["$1$", "$-1$", "$0$", "Does not exist"], correctAnswer: 3 },
      { id: 31, text: "$\\lim_{x \\to 0} \\frac{1}{x} \\ln(\\frac{1+x}{1-x}) = ?$", options: ["$1$", "$2$", "$1/2$", "$0$"], correctAnswer: 1 },
      { id: 32, text: "$\\lim_{x \\to 0} \\frac{\\tan x - \\sin x}{x^3 \\cos x} = ?$", options: ["$1/2$", "$1$", "$1/4$", "$1/8$"], correctAnswer: 0 },
      { id: 33, text: "$\\lim_{x \\to \\infty} (\\sqrt{x^2+8x+3} - \\sqrt{x^2+4x+3}) = ?$", options: ["$1$", "$2$", "$4$", "$8$"], correctAnswer: 1 },
      { id: 34, text: "$\\lim_{x \\to 0} \\frac{\\sin(x^n) - (\\sin x)^n}{x^{n+2}} = ?$", options: ["$n/3$", "$n/6$", "$n/2$", "$n$"], correctAnswer: 1 },
      { id: 35, text: "$\\lim_{x \\to 0} \\frac{1 - \\cos x \\sqrt{\\cos 2x}}{x^2} = ?$", options: ["$1/2$", "$1$", "$3/2$", "$2$"], correctAnswer: 2 },
      { id: 36, text: "$\\lim_{x \\to 0} \\frac{e^{\\sin x} - \\sin x - 1}{x^2} = ?$", options: ["$1/2$", "$1$", "$1/4$", "$0$"], correctAnswer: 0 },
      { id: 37, text: "$\\lim_{x \\to 0} \\frac{\\ln(1+x^2)}{\\sec x - 1} = ?$", options: ["$1/2$", "$1$", "$2$", "$4$"], correctAnswer: 2 },
      { id: 38, text: "$\\lim_{x \\to 0} \\frac{x \\tan 2x - 2x \\tan x}{(1-\\cos 2x)^2} = ?$", options: ["$1/2$", "$1/4$", "$1/8$", "$1$"], correctAnswer: 0 },
      { id: 39, text: "$\\lim_{x \\to 0} \\frac{\\sqrt[3]{1+x} - 1}{x} = ?$", options: ["$1/2$", "$1/3$", "$1/4$", "$1$"], correctAnswer: 1 },
      { id: 40, text: "$\\lim_{x \\to \\infty} (\\frac{x^2+5x+3}{x^2+x+2})^x = ?$", options: ["$e^2$", "$e^3$", "$e^4$", "$e^5$"], correctAnswer: 2 },
      { id: 41, text: "$\\lim_{x \\to 0} \\frac{\\sin(a+2)x + \\sin x}{x} = ?$", options: ["$a+1$", "$a+2$", "$a+3$", "$a$"], correctAnswer: 2 },
      { id: 42, text: "$\\lim_{x \\to 0} \\frac{8^x - 4^x - 2^x + 1}{x^2} = ?$", options: ["$\\ln 2 \\ln 4$", "$\\ln 2 \\ln 8$", "$\\ln 4 \\ln 8$", "$(\\ln 2)^2$"], correctAnswer: 0 },
      { id: 43, text: "$\\lim_{x \\to 0} \\frac{\\cos(\\sin x) - \\cos x}{x^4} = ?$", options: ["$1/2$", "$1/4$", "$1/6$", "$1/8$"], correctAnswer: 2 },
      { id: 44, text: "$\\lim_{x \\to 0} \\frac{\\ln(\\cos x)}{x^2} = ?$", options: ["$1/2$", "$-1/2$", "$1$", "$-1$"], correctAnswer: 1 },
      { id: 45, text: "$\\lim_{x \\to \\pi/4} \\frac{1 - \\tan x}{x - \\pi/4} = ?$", options: ["$2$", "$-2$", "$1$", "$-1$"], correctAnswer: 1 },
      { id: 46, text: "$\\lim_{x \\to 0} \\frac{x - \\tan^{-1} x}{x^3} = ?$", options: ["$1/2$", "$1/3$", "$1/6$", "$1$"], correctAnswer: 1 },
      { id: 47, text: "$\\lim_{x \\to 0} \\frac{\\sin^{-1} x - x}{x^3} = ?$", options: ["$1/2$", "$1/3$", "$1/6$", "$1$"], correctAnswer: 2 },
      { id: 48, text: "$\\lim_{x \\to 0} \\frac{\\sqrt{1+x} - \\sqrt{1-x}}{\\sin x} = ?$", options: ["$1/2$", "$1$", "$2$", "$0$"], correctAnswer: 1 },
      { id: 49, text: "$\\lim_{x \\to \\infty} x^2 (1 - \\cos(1/x)) = ?$", options: ["$1$", "$1/2$", "$2$", "$0$"], correctAnswer: 1 },
      { id: 50, text: "$\\lim_{x \\to 0} \\frac{e^{ax} - e^{bx}}{x} = ?$", options: ["$a+b$", "$a-b$", "$ab$", "$a/b$"], correctAnswer: 1 }
    ]
  }
];
